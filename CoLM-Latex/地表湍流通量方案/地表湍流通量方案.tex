...
\frac{\kappa U_{h}}{u_{*}} = \ln {\frac{h-d}{z_{0}}} + \Psi_{h}
\end{equation}
易得：
...
\frac{\kappa U_{h}}{u_{*}} =& \ln {\frac{z-d}{z_{0}}} + \Psi_{h} + \int_{h}^{z_{w}} \frac{\varphi \phi - 1}{z-d} d z
+ \int_{z_{w}}^{z} \frac{\varphi \phi - 1}{z-d} d z \nonumber \\
=& \ln {\frac{z-d}{z_{0}}} + \Psi_{h} + \left[\int_{h}^{z_{w}} \frac{\phi}{z_{w}-d} d z - \ln {\frac{z_{w}-d}{h-d}}\right]
+ \int_{z_{w}}^{z} \frac{\varphi \phi - 1}{z-d} d z
\end{align}
